    ...
    <View style={styles.card}>
      ...
      <View style={styles.cardBottom}>
        ...
        <View style={styles.actions}>
          <View style={styles.rating}>{host.rating ? <><Star size={13} color="#77530A" fill="#77530A" /><Text style={styles.ratingText}>{host.rating.toFixed(1)}</Text></> : <Text style={styles.newText}>New</Text>}</View>
...
const styles = StyleSheet.create({
  ...
  fallbackText: {fontSize: 52, fontWeight: '900', color: colors.teal}, cardTop: {position: 'absolute', left: spacing.xs, right: spacing.xs, top: spacing.xs, flexDirection: 'row', justifyContent: 'space-between'}, presence: {height: 27, paddingHorizontal: spacing.xs, flexDirection: 'row', gap: 5, alignItems: 'center', borderRadius: radii.round, backgroundColor: 'rgba(25,28,32,0.72)'}, online: {backgroundColor: 'rgba(17,126,88,0.88)'}, busy: {backgroundColor: 'rgba(166,109,0,0.88)'}, presenceDot: {width: 7, height: 7, borderRadius: 4, backgroundColor: colors.white}, presenceText: {color: colors.white, fontSize: 10, fontWeight: '800'}, heart: {width: 34, height: 34, borderRadius: 17, backgroundColor: 'rgba(255,255,255,0.92)', alignItems: 'center', justifyContent: 'center'}, cardBottom: {padding: spacing.sm, gap: spacing.xs},
  nameRow: {flexDirection: 'row', alignItems: 'center', gap: spacing.xs},
  hostName: {flexShrink: 1, color: colors.ink, fontSize: 15, fontWeight: '900'}, location: {color: colors.muted, fontSize: 11, marginTop: 3}, rating: {height: 32, minWidth: 38, paddingHorizontal: 7, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 3, borderRadius: radii.sm, backgroundColor: colors.mustardSoft}, ratingText: {fontSize: 11, fontWeight: '900', color: '#77530A'}, newText: {fontSize: 10, fontWeight: '900', color: colors.warning}, actions: {flexDirection: 'row', gap: 5}, message: {borderColor: colors.coral, backgroundColor: colors.coral}, iconAction: {width: 32, height: 32, borderRadius: radii.sm, borderWidth: 1, borderColor: colors.line, backgroundColor: colors.canvas, alignItems: 'center', justifyContent: 'center'},
